 ...
 */
Double_t CosinePointingAngle(Double_t v0_px, Double_t v0_py, Double_t v0_pz,  //
                             Double_t v0_x, Double_t v0_y, Double_t v0_z,     //
                             Double_t ref_x, Double_t ref_y, Double_t ref_z) {
...
/*
 * Find the Distance of Closest Approach to the a reference point, after propagating a V0 as a line.
 */
...
/*
 * Overload of `LinePointDCA(...)`, using scalars instead of vectors.
 */
Double_t LinePointDCA(Double_t v0_px, Double_t v0_py, Double_t v0_pz,  //
                      Double_t v0_x, Double_t v0_y, Double_t v0_z,     //
                      Double_t ref_x, Double_t ref_y, Double_t ref_z) {
    ROOT::Math::XYZVector MomV0(v0_px, v0_py, v0_pz);
    ROOT::Math::XYZPoint PosV0(v0_x, v0_y, v0_z);
